// Robust Number Guess Program: The user inputs a number between 0 and 99,
// and the program tells the user how close the guess was.
// The program exits upon the correct answer.
...
public class NumberGuess3 {
   ...
   // returns # of matching digits between the two number
